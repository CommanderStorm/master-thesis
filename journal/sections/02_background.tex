...
The columnar \ac{MLT} format draws on database compression: SIMD integer codecs \citep{lemireDecodingBillionsIntegers2015}, the FSST string compressor \citep{bonczFSSTFastRandom2020}, and cascaded per-block strategy selection \citep{kuschewskiBtrBlocksEfficientColumnar2023}.
