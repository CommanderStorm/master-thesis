...
The finding in \cref{tab:mvt_mlt_comparison} that is easiest to overlook is that the reference baseline was \emph{worse} than gzip-compressed \ac{MVT} (\qty{3.54}{\giga\byte} vs.\ \qty{3.08}{\giga\byte}).
