...
\newline Step markers $\dagger$ and $\ast$: see the \hyperref[box:corpus_exclusions]{corpus-exclusions note} at the start of the chapter.}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=0.91\textheight]{figures/heatmap_loadMs.pdf}
	\caption{
...
\begin{figure}[H]
	\centering
	\includegraphics[height=0.91\textheight]{figures/heatmap_fps.pdf}
	\caption{
...
\begin{figure}[H]
	\centering
	\includegraphics[height=0.91\textheight]{figures/heatmap_jankCount}
	\caption{
