...
\csvreader[
  ...
  table head={\toprule
    ...
    \midrule},
  table foot={\midrule
    \multicolumn{7}{l}{\footnotesize $\dagger$ end-to-end styles only (see corpus-exclusions note).\quad $\ast$ requires tile data.} \\
    \bottomrule},
  head to column names,
...
Values are percentage of baseline, medians across the 13 benchmarked styles and 18 scenarios.
