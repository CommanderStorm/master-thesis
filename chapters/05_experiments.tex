...
The finding in \cref{tab:mvt_mlt_comparison} that is easiest to overlook is that the reference baseline \ac{MLT} under no compression was \emph{worse} than the commonly gzip-compressed \ac{MVT} (\qty{3.54}{\giga\byte} vs.\ \qty{3.08}{\giga\byte}).
