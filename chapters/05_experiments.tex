...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=.7\linewidth]{figures/rendering_metrics_mlt_fiord_loadMs.pdf}
        \caption{Fiord - load time.}
        \label{fig:rendering_metrics_mlt_fiord_load}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=.7\linewidth]{figures/rendering_metrics_mlt_fiord_fps.pdf}
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=.7\linewidth]{figures/rendering_metrics_mlt_liberty_loadMs.pdf}
        \caption{Liberty - load time.}
        \label{fig:rendering_metrics_mlt_liberty_load}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=.7\linewidth]{figures/rendering_metrics_mlt_liberty_fps.pdf}
