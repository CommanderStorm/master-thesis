...
Composed end-to-end across the deep-corpus styles, the full pipeline cut per-style median load time by \qty{71}{\percent} and lifted \ac{FPS} by \qty{152}{\percent}.
