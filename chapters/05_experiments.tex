...
ICGC Fosc, ICGC Gris, and Americana were excluded from the end-to-end pipeline because of an upstream bug in MapLibre's \texttt{gl-style-migrate} that miscompiles their legacy \mlprop{text-field} syntax (\cref{sub:deep_corpus}). Once layer merging (step~15) builds on that intermediate, the cumulative ablation would no longer be comparing like with like across the corpus.
