...
\begin{description}
    \item[Resource utilisation,] such as \ac{CPU} load, \ac{GPU} utilisation, and memory consumption to have pointers where further optimizations is possible.
    ...
    \item[Network utilisation,] including transferred bytes, tile request rates, and bandwidth consumption.
