...
Unlike general-purpose compressors such as LZ77~\cite{zivUniversalAlgorithmSequential1977} or ~\cite{colletZstandardCompressionApplication2021}, \ac{FSST} preserves random access, so each compressed string can be decompressed independently.
