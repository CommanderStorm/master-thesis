...
They do not evaluate multi-objective tradeoffs such as latency vs. energy consumption.
This thesis will fill this gap.

#figure(
  table(
    columns: (3em, 2em, 11em), // Approximation for p{3cm}|p{2cm}|p{11cm} - will adjust if needed
...
#figure(
  table(
    columns: (3em, 2em, 11em), // Approximation for p{3cm}|p{2cm}|p{11cm}
    align: (start, start, start),
    [*optimisation*], [*data*], [*description [technique]*],
    line(length: 100%),
    line(length: 100%),
