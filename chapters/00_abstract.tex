...
A set of peephole rules - constant folding, algebraic simplification, stats-driven folding from tile statistics, and selectivity-based predicate reordering - is applied to the style's \ac{JSON} expressions via fixpoint iteration.
