...
Let $\mathcal{T}$ be the set of tile sets, each a finite family of tiles indexed by source and $(x, y, z) \in \mathcal{N}_+^3$.\newline
Let $\mathcal{V}$ be the set of \emph{viewing states}: tuples $(\text{lat}_\text{center}, \text{lat}_\text{center}, z, \text{roll}, \text{pitch}, \text{bearing}, \text{viewport size}) \in \mathcal{R}^7$, the six degrees of freedom plus the viewport.\newline
