...
A subtle but load-bearing correctness concern is MapLibre's \emph{overzoom} behavior.
When a client requests a tile at a zoom level beyond a source's \mlprop{maxzoom}, the renderer reuses the nearest available tile from a lower zoom and upscales it.
