...
Let $\mathcal{V}$ be the set of \emph{viewing states}: tuples $(\text{lat}_\text{center}, \text{lat}_\text{center}, z, \text{roll}, \text{pitch}, \text{bearing}, \text{viewport size}) \in \mathbb{R}^7$. The six degrees of freedom plus the viewport.\newline
