...
noindent The advisory captures five categories of information for each source-layer:

\begin{description}
	\item[\textbf{Property usage.}] Properties referenced through
	\texttt{[\mlop{"get"},~\ldots]} or \texttt{[\mlop{"has"},~\ldots]},
	together with the zoom ranges over which they are referenced.
