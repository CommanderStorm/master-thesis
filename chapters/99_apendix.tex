...
In \cref{tab:maputnik_full}, we list the Maputnik catalog styles used in \cref{sec:exp_cross_style}, together with per-style metrics. Two additional catalog entries were unavailable (\ac{HTTP}~403).
...
Used as a sounding board on author-written material, suggesting rephrasings of sentences the author had already drafted, and discussing how to present or improve specific figures.
