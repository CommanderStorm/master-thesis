...
The BasemapDE pair stops at the static passes (steps 0--15) because no tile source could be provisioned in time (\cref{sub:deep_corpus}), despite attempts to contact the tile provider.
...
\perstyleablation{basemap_col}{BasemapDE Color}
