...
\clearpage
\section{Use of Generative AI and Writing Assistance Tools}\label{app:ai_disclosure}
...
\paragraph{Anthropic Claude, Google Gemini, Advisors (Paul Walther, Balthasar Teuscher).}
Used as a sounding board on author-written material, suggesting rephrasings of paragraphs the author had already drafted, and discussing how to present or improve specific figures.
