...
Step 17 (tile shave only, applied to the baseline tile data without prior structural rewrites) is still reported for them, leaving these three styles at 16 of 20 cumulative steps.
