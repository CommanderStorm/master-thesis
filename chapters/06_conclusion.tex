...
Yes, meaningfully.
The headline tile-size and load-time numbers are summarised under C4 and tabulated in \cref{tab:per_style_summary,tab:tile_sizes_per_zoom}.
...
Shaving removes columns at encoding time (early materialisation), selective decoding skips them at decode time (late materialisation), and the two are most valuable when they run together.
