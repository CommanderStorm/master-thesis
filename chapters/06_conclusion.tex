...
\begin{enumerate}[label=\textbf{C\arabic*}]
    ...
    \item The \textbf{empirical evaluation} (\cref{ch:experiments}), conducted across a 15-style deep corpus (13 benchmarked, with the BasemapDE pair excluded for data-access reasons), 18 scenarios, and 19 cumulative ablation steps.
...
All 11 \ac{OMT} styles in the deep corpus whose referenced tile data is fully available to us (the 10 end-to-end styles plus Americana) were measured for tile-shaving effectiveness on the Germany tileset (\qtyrange{19.8}{46.3}{\percent}, \cref{fig:tile_shave_per_style}).
