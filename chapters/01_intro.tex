...
\Cref{ch:experiments} measures the isolated and combined effects through a cumulative ablation across a 13-style deep corpus and 18~scenarios, and \cref{ch:conclusion} revisits R1-R3 in \cref{sec:rq_revisited} and names tile shaving and columnar re-encoding as the primary levers.
